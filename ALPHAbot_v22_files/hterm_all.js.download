...
hterm.Keyboard = function(terminal) {
  ...
  // PythonAnywhere addition; we don't care about the left-hand vs the right-hand control keys
  // so we just have a simple true/false
  this.ctrlKeyOverride = false;
...
hterm.Keyboard.prototype.onKeyDown_ = function(e) {
  ...
  var control = e.ctrlKey | this.ctrlKeyOverride;  // the ctrlKeyOverride is PythonAnywhere stuff
 ...
 */
// PythonAnywhere extra isMobile parameter
hterm.ScrollPort.prototype.decorate = function(div, isMobile) {
  this.div_ = div;
 ...
 */
hterm.Terminal.prototype.decorate = function(div, isMobile) {
  this.div_ = div;

  this.scrollPort_.decorate(div, isMobile);
